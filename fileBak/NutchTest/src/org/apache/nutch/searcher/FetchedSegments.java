...
//这里的生成摘要的方法是调用的插件中的方法，this.summarizer.getSummary(text, query);
//在srcBak － version-org － src － plugin － summary-basic － src － java － org － apache － nutch － summary ▸ basic下面的目录下，
// 可能使用的时候编译成了jar包直接调用的。那里是摘要生成的核心算法。
